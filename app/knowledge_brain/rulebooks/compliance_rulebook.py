...
COMPLIANCE_RULES = {
    "CMP_001_DSCR": {
        "domain": "finance",
        "title": "نسبة تغطية خدمة الدين",
        "authority": "SAMA",
        "reference": "إرشادات التمويل المؤسسي",
        "obligation": "recommended",
        "evaluate": _eval_dscr,
    },
    "CMP_002_LIQUIDITY": {
        "domain": "finance",
        "title": "السيولة للتمويل",
        "authority": "SAMA",
        "reference": "متطلبات التمويل البنكي",
        "obligation": "recommended",
        "evaluate": _eval_current_ratio_finance,
    },
    "CMP_003_LEVERAGE": {
        "domain": "finance",
        "title": "المديونية",
        "authority": "SAMA",
        "reference": "معايير التمويل المؤسسي",
        "obligation": "recommended",
        "evaluate": _eval_leverage,
    },
    ...
    "CMP_005_WORKING_CAPITAL": {
        ...
        "authority": "عام",
        "obligation": "recommended",
        "evaluate": _eval_working_capital,
    },
    "CMP_006_AUDIT_READY": {
        "domain": "accounting",
        "title": "جاهزية المراجعة",
        "authority": "SOCPA",
        "reference": "معايير المراجعة",
        "obligation": "recommended",
        "evaluate": _eval_audit_readiness,
    },
    "CMP_007_BALANCE": {
        "domain": "accounting",
        "title": "سلامة الميزانية",
        "authority": "SOCPA/IFRS",
        "reference": "IAS 1",
        "obligation": "mandatory",
        "evaluate": _eval_balance_sheet_integrity,
    },
}
