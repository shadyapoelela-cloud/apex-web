...
# Re-export engine/SessionLocal/Base/get_db from centralized module (app.core.database).
# Historical note: these used to be defined here. The whole app now has a single
# source of truth backed by app.core.config. Hundreds of existing imports keep working.
