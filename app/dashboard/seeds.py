...
DEFAULT_LAYOUTS: list[dict[str, Any]] = [
    {
        ...
        "blocks": [
            ...
            _block("list.top_customers",    x=0, y=2, span=6),
            _block("widget.compliance_health", x=6, y=2, span=3),
            _block("widget.ai_pulse",       x=9, y=2, span=3),
        ],
    },
    {
        "role_id": "accountant",
        ...
        "blocks": [
            ...
            _block("list.recent_invoices",  x=0, y=1, span=4),
            _block("list.pending_approvals", x=4, y=1, span=4),
            _block("chart.revenue_30d",     x=0, y=2, span=12),
        ],
    },
    {
        "role_id": "cashier",
