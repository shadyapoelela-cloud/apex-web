...
# Chart of Accounts (mounted at /api/v1/coa/*).
HAS_COA = False
try:
    from app.coa.router import router as coa_router
...
try:
    ...
    from app.pilot.routes.customer_routes import router as pilot_customer_router
    ...
    app.include_router(pilot_customer_router)
    HAS_PILOT = True
