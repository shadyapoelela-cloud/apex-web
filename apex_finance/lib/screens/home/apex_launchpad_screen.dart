  ...
  static final List<_Service> _services = [
    ...
    _Service(
      ...
      apps: [
        ...
        _App('ميزان المراجعة', 'TB + drill chain', '/app/erp/finance/statements', Icons.assessment),
    ...
    _Service(
      ...
      color: 0xFFE91E63,
      apps: [
        _App('التقويم الضريبي', '7 obligations سعودية', '/app/compliance/tax/calendar', Icons.event),
        _App('ZATCA Status Center', 'CSID + Queue + Errors', '/app/erp/finance/zatca-status', Icons.verified),
        _App('VAT Return', 'إقرار شهري', '/app/compliance/tax/vat-return', Icons.receipt_long),
        _App('الزكاة', 'الوعاء الزكوي 2.5%', '/app/compliance/tax/zakat', Icons.account_balance_wallet),
        _App('استقطاع المصدر WHT', '5/15/20% بحسب الفئة', '/app/compliance/tax/wht', Icons.percent),
        _App('IFRS 16 — الإيجارات', 'ROU + جدول إهلاك', '/app/compliance/ifrs/dashboard', Icons.apartment),
        _App('IFRS 10 — التوحيد', 'Multi-entity + استبعادات', '/app/erp/consolidation/dashboard', Icons.layers),
