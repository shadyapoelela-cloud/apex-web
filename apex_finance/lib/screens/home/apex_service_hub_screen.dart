...
class ApexServiceHubScreen extends StatelessWidget {
  ...
  static final Map<String, _ServiceConfig> _services = {
      ...
      sections: [
        ...
        _Section('المخرجات — التقارير',
          ...
          tiles: [
            ...
            _Tile('VAT Return', 'إقرار الضريبة', '/app/compliance/tax/vat-return', Icons.receipt_long),
            _Tile('ميزان المراجعة', 'TB + drill', '/app/erp/finance/statements', Icons.assessment),
    ...
    'purchase': _ServiceConfig(
      ...
      flow: ['/app/erp/purchasing/suppliers', '/app/erp/finance/purchase-bills', '/app/erp/purchasing/ap-aging'],
      sections: [
        _Section('المدخلات — إنشاء',
          icon: Icons.input,
          color: 0xFF4CAF50,
          tiles: [
            _Tile('فاتورة شراء', 'تسجيل + WHT', '/app/erp/finance/purchase-bills', Icons.receipt_outlined),
        ...
        _Section('الدفاتر — السجلات',
          ...
          color: 0xFF9C27B0,
          tiles: [
            _Tile('قائمة الموردين', 'كل الموردين', '/app/erp/purchasing/suppliers', Icons.business),
            _Tile('قائمة الفواتير', 'Bills + filters', '/app/erp/finance/purchase-bills', Icons.list_alt),
          ]),
        _Section('المخرجات — التقارير',
          icon: Icons.assessment,
          color: 0xFFFFC107,
          tiles: [
            _Tile('أعمار AP', 'AP Aging buckets', '/app/erp/purchasing/ap-aging', Icons.timeline),
            _Tile('استقطاع المصدر WHT', '5/15/20%', '/app/compliance/tax/wht', Icons.percent),
            _Tile('VAT Return', 'الضريبة المدخلة', '/app/compliance/tax/vat-return', Icons.receipt_long),
            _Tile('قائمة القيود', 'JE المُولّدة تلقائياً', '/app/erp/finance/je-builder', Icons.book),
          ]),
        _Section('الإعدادات',
          icon: Icons.settings,
      ...
      tiles: [
        _Tile('الموردون', 'قائمة + Vendor 360', '/app/erp/purchasing/suppliers', Icons.business, featured: true),
        _Tile('فواتير الموردين', 'Bills List + filters', '/app/erp/finance/purchase-bills', Icons.receipt_outlined, featured: true),
        _Tile('أعمار AP', 'AP Aging buckets', '/app/erp/purchasing/ap-aging', Icons.timeline, featured: true),
      ],
    ),
    'accounting': _ServiceConfig(
      ...
      color: 0xFF9C27B0,
      heroRoute: '/app/erp/finance/statements',
      heroLabel: 'افتح ميزان المراجعة (Live)',
      flow: ['/app/erp/finance/coa-editor', '/app/erp/finance/je-builder', '/app/erp/finance/statements', '/operations/period-close'],
      sections: [
        _Section('المدخلات — مستندات المصدر',
          ...
          tiles: [
            ...
            _Tile('فاتورة مشتريات', 'تسجيل + WHT', '/app/erp/finance/purchase-bills', Icons.receipt_outlined),
            _Tile('بيع سريع POS', 'Mada/STC/Apple Pay', '/pos/quick-sale', Icons.point_of_sale),
            _Tile('التقاط إيصال', 'OCR — Claude Vision', '/receipt/capture', Icons.document_scanner),
          ]),
        _Section('الدفاتر — التسجيل',
          ...
          tiles: [
            ...
            _Tile('شجرة الحسابات', 'CoA Tree (SOCPA)', '/app/erp/finance/coa-editor', Icons.account_tree),
            _Tile('التسوية البنكية AI', 'Auto-match >95%', '/app/erp/treasury/recon', Icons.account_balance_wallet),
          ]),
        _Section('المخرجات — القوائم المالية',
          icon: Icons.assessment,
          color: 0xFFFFC107,
          tiles: [
            _Tile('ميزان المراجعة', 'TB + Drill chain', '/app/erp/finance/statements', Icons.assessment),
        ...
        _Section('الإعدادات',
          ...
          color: 0xFF795548,
          tiles: [
            _Tile('محرر الحسابات', 'إضافة/تعديل CoA', '/app/erp/finance/coa-editor', Icons.edit_note),
      ...
      tiles: [
        ...
        _Tile('شجرة الحسابات', 'CoA Tree (SOCPA)', '/app/erp/finance/coa-editor', Icons.account_tree, featured: true),
        _Tile('محرر الحسابات', 'CoA Editor', '/app/erp/finance/coa-editor', Icons.edit_note),
        _Tile('ميزان المراجعة', 'TB + drill chain', '/app/erp/finance/statements', Icons.assessment, featured: true),
        _Tile('التسوية البنكية AI', 'Auto-match >95%', '/app/erp/treasury/recon', Icons.account_balance_wallet),
        _Tile('إقفال الفترة', 'NetSuite checklist', '/operations/period-close', Icons.lock_clock),
      ],
    ),
      ...
      sections: [
        ...
        _Section('المخرجات',
          ...
          tiles: [
            ...
            _Tile('ميزان المراجعة', 'TB live', '/app/erp/finance/statements', Icons.assessment),
          ]),
      ],
      tiles: [
    ...
    'compliance-hub': _ServiceConfig(
      ...
      icon: Icons.gavel,
      color: 0xFFE91E63,
      heroRoute: '/app/compliance/tax/calendar',
      heroLabel: 'افتح التقويم الضريبي السعودي',
      flow: ['/app/compliance/tax/calendar', '/app/erp/finance/zatca-status', '/app/compliance/tax/vat-return', '/compliance/activity-log-v2'],
      sections: [
        _Section('الضرائب — حسابات + إقرارات',
          icon: Icons.calculate,
          color: 0xFF4CAF50,
          tiles: [
            _Tile('VAT Return', 'إقرار شهري', '/app/compliance/tax/vat-return', Icons.receipt_long),
            _Tile('الزكاة', '2.5% من الوعاء', '/app/compliance/tax/zakat', Icons.account_balance_wallet),
            _Tile('استقطاع المصدر WHT', '5/15/20%', '/app/compliance/tax/wht', Icons.percent),
          ]),
        _Section('ZATCA Phase 2',
          ...
          color: 0xFF2196F3,
          tiles: [
            _Tile('التقويم الضريبي', '7 obligations', '/app/compliance/tax/calendar', Icons.event),
            _Tile('ZATCA Status Center', 'CSID + Queue + Errors', '/app/erp/finance/zatca-status', Icons.verified),
          ]),
        _Section('IFRS — معايير دولية',
          icon: Icons.account_balance,
          color: 0xFF9C27B0,
          tiles: [
            _Tile('IFRS 16 — الإيجارات', 'ROU + جدول إهلاك', '/app/compliance/ifrs/dashboard', Icons.apartment),
            _Tile('IFRS 10 — التوحيد', 'Multi-entity', '/app/erp/consolidation/dashboard', Icons.layers),
          ]),
      ...
      tiles: [
        _Tile('التقويم الضريبي', '7 obligations', '/app/compliance/tax/calendar', Icons.event, featured: true),
        _Tile('ZATCA Status Center', 'CSID + Queue + Errors', '/app/erp/finance/zatca-status', Icons.verified, featured: true),
        _Tile('VAT Return', 'إقرار شهري', '/app/compliance/tax/vat-return', Icons.receipt_long),
        _Tile('الزكاة', 'الوعاء الزكوي 2.5%', '/app/compliance/tax/zakat', Icons.account_balance_wallet),
        _Tile('استقطاع المصدر WHT', '5/15/20%', '/app/compliance/tax/wht', Icons.percent),
        _Tile('IFRS 16 — الإيجارات', 'ROU + جدول إهلاك', '/app/compliance/ifrs/dashboard', Icons.apartment),
        _Tile('IFRS 10 — التوحيد', 'Multi-entity', '/app/erp/consolidation/dashboard', Icons.layers),
