    ...
    'sales': _ServiceConfig(
      ...
      sections: [
        _Section('المدخلات — إنشاء',
          ...
          color: 0xFF4CAF50,
          tiles: [
            _Tile('عرض سعر جديد', 'Pipeline + Win %', '/sales/quotes', Icons.description),
            _Tile('فاتورة مبيعات', 'إصدار + ZATCA', '/sales/invoices', Icons.receipt),
            _Tile('فاتورة متكررة', 'MRR + ARR', '/sales/recurring', Icons.repeat),
            _Tile('بيع سريع POS', 'Mada/STC/Apple Pay', '/pos/quick-sale', Icons.point_of_sale),
            _Tile('إشعار دائن/مدين', 'Credit/Debit notes', '/sales/memos', Icons.note),
          ]),
        _Section('الدفاتر — السجلات',
          icon: Icons.menu_book,
          color: 0xFF9C27B0,
          tiles: [
            _Tile('قائمة العملاء', 'كل العملاء', '/sales/customers', Icons.people),
            _Tile('قائمة الفواتير', '5 filters + WhatsApp', '/sales/invoices', Icons.receipt_long),
            _Tile('قائمة العروض', 'Quotes pipeline', '/sales/quotes', Icons.list_alt),
          ]),
        _Section('المخرجات — التقارير',
          icon: Icons.assessment,
          color: 0xFFFFC107,
          tiles: [
            _Tile('أعمار AR', '5 buckets ملوّنة', '/sales/aging', Icons.timeline),
            ...
            _Tile('قائمة القيود', 'JE المُولّدة تلقائياً', '/accounting/je-list', Icons.book),
          ]),
        _Section('الإعدادات',
          icon: Icons.settings,
          color: 0xFF795548,
    ...
    'operations': _ServiceConfig(
      ...
      sections: [
        ...
        _Section('المخرجات',
          ...
          tiles: [
            _Tile('إقفال الفترة', 'NetSuite checklist', '/operations/period-close', Icons.lock_clock),
            _Tile('قائمة القيود', 'JE من POS', '/accounting/je-list', Icons.book),
