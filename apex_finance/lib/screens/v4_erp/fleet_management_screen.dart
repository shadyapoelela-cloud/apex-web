...
class _FleetManagementScreenState extends State<FleetManagementScreen>
  ...
  final _vehicles = const [
    _Vehicle('FL-001', 'لكزس LX 600 2024', 'SUV', 'خالد العتيبي', 'active', 18500, 45000, '2026-05-15', '2026-08-30', 380000, Colors.blue),
    _Vehicle('FL-002', 'تويوتا هايلكس 2023', 'Pickup', 'محمد القحطاني', 'active', 62000, 120000, '2026-04-28', '2026-07-10', 145000, Colors.orange),
    _Vehicle('FL-003', 'مرسيدس G-Class 2025', 'SUV', 'الرئيس التنفيذي', 'active', 4200, 10000, '2026-09-01', '2027-01-15', 720000, Colors.red),
    _Vehicle('FL-004', 'إيسوزو شاحنة 2022', 'Truck', 'فهد الشمري', 'maintenance', 125000, 45000, '2026-05-08', '2026-06-20', 195000, Colors.orange),
    _Vehicle('FL-005', 'نيسان ألتيما 2024', 'Sedan', 'سارة الدوسري', 'active', 28500, 48000, '2026-07-22', '2026-09-30', 95000, Colors.green),
    _Vehicle('FL-006', 'تويوتا كامري 2023', 'Sedan', 'نورة الغامدي', 'active', 42000, 56000, '2026-06-15', '2026-08-22', 92000, Colors.teal),
    _Vehicle('FL-007', 'إيسوزو ميني فان 2022', 'Van', 'سائق توصيل', 'active', 98000, 95000, '2026-05-02', '2026-07-18', 125000, Colors.purple),
    _Vehicle('FL-008', 'هيونداي إلنترا 2021', 'Sedan', 'لينا البكري', 'active', 68000, 72000, '2026-05-20', '2026-08-05', 68000, Colors.pink),
  ];
  ...
  Widget _buildKpis() {
    ...
    return Padding(
      ...
      child: Row(
        children: [
          _kpi('إجمالي الأسطول', '${_vehicles.length}', Colors.blue, Icons.directions_car),
          _kpi('نشطة', '$active', Colors.green, Icons.check_circle),
          _kpi('قيد الصيانة', '$inMaint', Colors.orange, Icons.build),
          _kpi('تراخيص قرب انتهاء', '$upcomingRenewals', Colors.red, Icons.warning),
          _kpi('قيمة الأسطول', '${_fmtM(totalValue)} ر.س', const Color(0xFFD4AF37), Icons.attach_money),
        ],
      ),
    );
  }
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        Text(v.driver, style: const TextStyle(fontSize: 11, color: Colors.black54)),
                      ],
                    ),
                  ],
                ),
              ...
              Expanded(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        const Icon(Icons.local_gas_station, size: 12, color: Colors.black54),
                        const SizedBox(width: 3),
                        Text('${v.fuelMonthly} ل/شهر', style: const TextStyle(fontSize: 11)),
                      ],
                    ),
                    Text('قيمة: ${_fmt(v.value)} ر.س',
                        style: const TextStyle(fontSize: 11, color: Color(0xFFD4AF37), fontWeight: FontWeight.w700)),
                  ],
                ),
              ),
              Expanded(
                ...
                child: Column(
                  ...
                  children: [
                    Row(
                      children: [
                        Icon(Icons.description, size: 11, color: daysLeft < 60 ? Colors.red : Colors.black54),
                        const SizedBox(width: 3),
                        Expanded(
                          child: Text('استمارة: ${v.registrationExpiry}',
                              style: TextStyle(
                                  fontSize: 10,
                                  color: daysLeft < 60 ? Colors.red : Colors.black54,
                    ...
                    Row(
                      children: [
                        const Icon(Icons.shield, size: 11, color: Colors.black54),
                        const SizedBox(width: 3),
                        Expanded(
  ...
  Widget _maintRow(_MaintRecord r) {
    final statusColor = r.status == 'مكتمل' ? Colors.green : r.status == 'قيد التنفيذ' ? Colors.orange : Colors.blue;
    return Container(
      margin: const EdgeInsets.only(bottom: 10),
      padding: const EdgeInsets.all(14),
      decoration: BoxDecoration(
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(r.provider, style: const TextStyle(fontSize: 11, color: Colors.black54)),
              ],
            ),
          ),
          Expanded(
  ...
  Widget _buildFuelTab() {
    ...
    return ListView(
      ...
      children: [
        Row(
          children: [
            _fuelStat('استهلاك أبريل', '1,650 لتر', '+7% MoM', Colors.orange, Icons.local_gas_station),
            _fuelStat('تكلفة أبريل', '18,500 ر.س', '+7% MoM', const Color(0xFFD4AF37), Icons.attach_money),
            _fuelStat('متوسط كم/لتر', '14.2', 'تحسّن +0.3', Colors.green, Icons.speed),
            _fuelStat('إجمالي YTD', '6,490 لتر', '73K ر.س', Colors.blue, Icons.timeline),
          ],
        ),
        const SizedBox(height: 16),
        Container(
          ...
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              const Text('استهلاك الوقود الشهري', style: TextStyle(fontSize: 14, fontWeight: FontWeight.w900)),
              const SizedBox(height: 16),
              SizedBox(
                height: 180,
                child: Row(
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text('${m.liters}L', style: const TextStyle(fontSize: 9, color: Colors.black54)),
                            ],
                          ),
                        ),
                      ),
