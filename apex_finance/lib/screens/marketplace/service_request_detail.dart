...
class ServiceRequestDetail extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(backgroundColor: AC.navy2, title: const Text('\u062a\u0641\u0627\u0635\u064a\u0644 \u0627\u0644\u0637\u0644\u0628', style: TextStyle(color: AC.tp))),
      body: ListView(padding: const EdgeInsets.all(14), children: [
        Container(padding: const EdgeInsets.all(16), decoration: BoxDecoration(color: AC.navy3, borderRadius: BorderRadius.circular(14), border: Border.all(color: AC.bdr)),
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            Text(request['title'] ?? '\u0637\u0644\u0628 \u062e\u062f\u0645\u0629', style: const TextStyle(color: AC.tp, fontSize: 18, fontWeight: FontWeight.bold)),
  ...
  Widget _row(String k, String v) => Padding(padding: const EdgeInsets.only(bottom: 6), child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
    Text(k, style: const TextStyle(color: AC.ts, fontSize: 12)), Text(v, style: const TextStyle(color: AC.tp, fontSize: 12))]));

  Widget _timeline() => Container(padding: const EdgeInsets.all(14), decoration: BoxDecoration(color: AC.navy3, borderRadius: BorderRadius.circular(14), border: Border.all(color: AC.bdr)),
    child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      const Text('\u0645\u0633\u0627\u0631 \u0627\u0644\u0637\u0644\u0628', style: TextStyle(color: AC.gold, fontWeight: FontWeight.bold)),
