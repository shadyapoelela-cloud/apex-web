...
class _SalesInvoicesScreenState extends State<SalesInvoicesScreen> {
  ...
  // A8 (Wave 4): CSV download is real now. Print and delete still
    ...
    ApexCsvExport.download<Map<String, dynamic>>(
      ...
      columns: [
        ...
        ApexCsvColumn(
            ...
            extract: (r) => (r['issue_date'] ?? '').toString()),
        ApexCsvColumn(
        ...
        ApexCsvColumn(
            header: 'العميل',
            extract: (r) =>
                (r['customer_name'] ?? r['customer_id'] ?? '').toString()),
        ApexCsvColumn(
            header: 'الإجمالي',
