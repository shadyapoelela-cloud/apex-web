...
class VendorPaymentScreen extends StatefulWidget {
  final String billId;
  const VendorPaymentScreen({super.key, required this.billId});
...
class _VendorPaymentScreenState extends State<VendorPaymentScreen> {
  ...
  Future<void> _submit() async {
    ...
    final res = await ApiService.pilotCreateVendorPayment({
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('تسجيل دفعة مورد', style: TextStyle(color: AC.gold)),
      ),
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.stretch, children: [
          ...
          _card('المرجع', [
            TextField(
              ...
              decoration: InputDecoration(
                hintText: 'مرجع التحويل أو الشيك',
