...
class ResultDetailPanel extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return DraggableScrollableSheet(
      ...
      builder: (_, sc) => Container(
        ...
        child: ListView(controller: sc, padding: EdgeInsets.all(20), children: [
  ...
  Widget _section(String title, IconData icon, String content) => Container(
    margin: EdgeInsets.only(bottom: 14), padding: const EdgeInsets.all(12),
  ...
  Widget _evidenceCard(dynamic e) => Container(
    margin: EdgeInsets.only(bottom: 6), padding: const EdgeInsets.all(10),
  ...
  Widget _refCard(dynamic ref) => Container(
    margin: EdgeInsets.only(bottom: 6), padding: const EdgeInsets.symmetric(horizontal: 10, vertical: 6),
  ...
  Widget _warningCard(dynamic w) => Container(
    margin: EdgeInsets.only(bottom: 6), padding: const EdgeInsets.all(8),
