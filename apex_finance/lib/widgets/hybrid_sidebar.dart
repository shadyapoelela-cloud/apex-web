...
class _HybridSidebarState extends State<HybridSidebar> {
  ...
  final List<_NavGroup> _groups = [
    ...
    _NavGroup('القوائم المالية', Icons.auto_graph_rounded, [
      _NavItem('القوائم (TB/IS/BS)', '/app/erp/finance/statements',
          Icons.auto_graph_rounded),
      _NavItem('قائمة التدفقات', '/app/erp/finance/cashflow',
          Icons.water_drop_rounded),
      _NavItem('التوحيد', '/app/erp/consolidation/dashboard', Icons.merge_type_rounded),
      _NavItem('المؤشرات المالية', '/app/advisory/ratios/dashboard',
          Icons.analytics_rounded),
    ]),
    _NavGroup('القيود والتدقيق', Icons.edit_note_rounded, [
      _NavItem('بنّاء القيود', '/app/erp/finance/je-builder/new',
          Icons.edit_note_rounded),
      _NavItem('أرقام القيود', '/app/erp/finance/je-builder',
          Icons.confirmation_number_rounded),
      _NavItem('سجل التدقيق', '/app/audit/trail',
          Icons.lock_outline_rounded),
    ]),
    _NavGroup('الضرائب والامتثال', Icons.receipt_long_rounded, [
      _NavItem('فاتورة ZATCA', '/app/compliance/zatca/invoice',
          Icons.receipt_long_rounded),
      _NavItem('الزكاة', '/app/compliance/tax/zakat', Icons.savings_rounded),
      _NavItem('إقرار VAT', '/app/compliance/tax/vat-return', Icons.receipt_rounded),
      _NavItem('ضريبة الاستقطاع', '/app/compliance/tax/wht', Icons.gavel_rounded),
      _NavItem('الضرائب المؤجّلة', '/app/compliance/ifrs/deferred-tax',
          Icons.schedule_send_rounded),
      _NavItem('تسعير التحويل', '/app/compliance/tax/tp',
          Icons.compare_rounded),
    ]),
    _NavGroup('الأصول والإيجار', Icons.inventory_rounded, [
      _NavItem('سجل الأصول', '/app/erp/finance/fixed-assets', Icons.inventory),
      _NavItem('محاسبة الإيجار', '/app/compliance/ifrs/dashboard', Icons.timeline_rounded),
      _NavItem('الإهلاك', '/app/erp/finance/depreciation', Icons.auto_graph_rounded),
    ]),
    _NavGroup('العمليات', Icons.settings_rounded, [
      _NavItem('الرواتب + GOSI', '/app/erp/hr/payroll', Icons.badge_rounded),
      _NavItem('التسوية البنكية', '/app/erp/treasury/recon',
          Icons.account_balance_rounded),
      _NavItem('المخزون', '/app/erp/inventory/inventory', Icons.inventory_2_rounded),
      _NavItem('أعمار الذمم', '/compliance/aging', Icons.bar_chart_rounded),
      _NavItem('الأقساط', '/app/erp/finance/amortization', Icons.schedule_rounded),
    ]),
    _NavGroup('التقييم والتمويل', Icons.trending_up_rounded, [
      _NavItem('تغطية الدين (DSCR)', '/app/advisory/ratios/dscr',
          Icons.account_balance_rounded),
      _NavItem('التقييم (WACC/DCF)', '/app/advisory/valuation/dashboard',
          Icons.query_stats_rounded),
      _NavItem('NPV/IRR', '/app/advisory/valuation/investment', Icons.insights_rounded),
      _NavItem('نقطة التعادل', '/app/advisory/ratios/breakeven', Icons.balance_rounded),
    ]),
    _NavGroup('أدوات متقدمة', Icons.all_inclusive_rounded, [
      _NavItem('IFRS (5-in-1)', '/app/compliance/ifrs/tools', Icons.style_rounded),
      _NavItem('Extras (7-in-1)', '/app/compliance/ifrs/extras',
          Icons.all_inclusive_rounded),
      _NavItem('انحرافات التكاليف', '/app/erp/finance/dashboard',
          Icons.analytics_rounded),
      _NavItem('محوّل العملات', '/app/erp/treasury/fx-converter',
          Icons.swap_horiz_rounded),
      _NavItem('OCR الفواتير', '/app/erp/finance/receipt-capture', Icons.document_scanner_rounded),
    ]),
...
class _NewMenuDialog extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final items = [
      ...
      ('فاتورة ZATCA', Icons.receipt_long_rounded, '/app/compliance/zatca/invoice'),
      ('قيد محاسبي', Icons.edit_note_rounded,
          '/app/erp/finance/je-builder/new'),
      ('قائمة مالية', Icons.auto_graph_rounded,
          '/app/erp/finance/statements'),
      ('تحويل عملة', Icons.swap_horiz_rounded, '/app/erp/treasury/fx-converter'),
