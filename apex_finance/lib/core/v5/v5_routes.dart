              ...
              Row(
                children: [
                  Expanded(child: _AiQuickLink(
                    ...
                    onTap: () => context.push('/compliance/journal-entry-builder'),
                  )),
                  const SizedBox(width: 10),
                  Expanded(child: _AiQuickLink(
                    icon: Icons.assessment_outlined,
                    label: 'القوائم المالية',
                    subtitle: 'P&L + BS + قيود الإقفال',
                    onTap: () => context.push('/compliance/financial-statements'),
                  )),
                  const SizedBox(width: 10),
                  Expanded(child: _AiQuickLink(
                    icon: Icons.insights,
                    ...
                    onTap: () => context.push('/compliance/ratios'),
                  )),
                ],
              ),
              const SizedBox(height: 10),
