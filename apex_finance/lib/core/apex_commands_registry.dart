...
List<ApexCommand> buildAppCommands(BuildContext context) {
  ...
  final commands = <ApexCommand>[
    ...
    ApexCommand(
      ...
      onRun: (_) => go('/hr/timesheet'),
    ),
    ApexCommand(
      id: 'nav_petty_cash',
      label: 'العهدة النقدية',
      subtitle: 'Petty Cash + replenishment alerts',
      kind: ApexCommandKind.navigation,
      icon: Icons.savings,
      onRun: (_) => go('/operations/petty-cash'),
    ),
    ApexCommand(
      id: 'nav_stock_card',
      label: 'بطاقة الصنف',
      subtitle: 'Stock card timeline + running balance',
      kind: ApexCommandKind.navigation,
      icon: Icons.timeline,
      onRun: (_) => go('/operations/stock-card'),
    ),
    ApexCommand(
    ...
    ApexCommand(
      id: 'nav_credit_memos',
      label: 'الإشعارات الدائنة/المدينة',
    ...
    ApexCommand(
      ...
      label: 'تقارير المصاريف',
      subtitle: 'Employee expenses + approval workflow',
      kind: ApexCommandKind.navigation,
      icon: Icons.receipt_long,
      onRun: (_) => go('/hr/expense-reports'),
    ),
    ApexCommand(
    ...
    ApexCommand(
      ...
      onRun: (_) => go('/operations/inventory-v2'),
    ),
    ApexCommand(
      id: 'nav_fixed_assets_v2',
      label: 'سجل الأصول الثابتة',
      subtitle: 'IAS 16 + Depreciation + NBV',
      kind: ApexCommandKind.navigation,
      icon: Icons.business,
      onRun: (_) => go('/operations/fixed-assets-v2'),
    ),
    ApexCommand(
      id: 'nav_budget_variance_v2',
      label: 'تحليل الانحرافات',
      subtitle: 'Budget vs Actual بـ IBCS bars',
      kind: ApexCommandKind.navigation,
      icon: Icons.bar_chart,
      onRun: (_) => go('/analytics/budget-variance-v2'),
    ),
    ApexCommand(
      id: 'nav_payroll_run',
      label: 'تشغيل الرواتب',
