...
class ApiService {
  ...
  static Future<ApiResult> createClient({required String clientCode, required String name, required String clientType, String? industry, String? country, String? currency}) => _post('/clients', {'client_code':clientCode,'name':name,'client_type':clientType,if(industry!=null)'industry':industry,if(country!=null)'country':country,if(currency!=null)'currency':currency});
