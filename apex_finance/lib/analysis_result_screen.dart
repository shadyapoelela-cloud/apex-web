...
class _AnalysisResultScreenState extends State<AnalysisResultScreen> with TickerProviderStateMixin {
  ...
  List<dynamic> get _ratios=>widget.apiData?['ratios']??[];
  List<dynamic> get _insights=>widget.apiData?['knowledge_brain']??[];
  double get _score=>((widget.apiData?['readiness']?['readiness_score'])??0).toDouble();
  String get _label=>widget.apiData?['readiness']?['readiness_label']??'';
  Map get _summary=>widget.apiData?['income_statement']??{};
  List<dynamic> get _warnings=>widget.apiData?['warnings']??[];
  @override
